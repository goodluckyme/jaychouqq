...
"""
韩小圈 / 韩剧TV
列表接口: /api/series/index （offset 分页，无需加密）
详情接口: /api/series/detail
"""
import base64
import hashlib
import json
...
if __name__ == '__main__':
    ...
    print('--- category ---')
    print(json.dumps(spider.categoryContent('1', 1, {}, {}), ensure_ascii=False)[:800])
